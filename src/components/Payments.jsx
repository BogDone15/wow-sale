	...
	return (
		<>
			<Link
				...
				className=' text-[#d7aa47] text-center m-auto w-full inline-block font-bold text-base sm:text-2xl mb-5'
			>
				<span className='bg-[#3e3a31]'>
				...
				<br />
				<span className='bg-[#3e3a31]'>https://t.me/Makoker</span>
			</Link>
